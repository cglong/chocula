...
public class TreatmentRecordFrame extends JFrame implements UIInfo {
	...
	public TreatmentRecordFrame(final TreatmentRecord treatmentRecord) {
		if (treatmentRecord == null) {
			...
			prescription = treatmentRecord.getDoctorsOrders()
					.getPrescriptions();
					...
					if (changed) {
						...
						if (n == JOptionPane.CANCEL_OPTION) {
							...
							Storage.getInstance().updateTreatmentRecord(
									treatmentRecord, new Doctor(tdoc, null),
									date, new Nurse(nurse, null), docorder,
									complaint, vitalsigns, diag,
									treatmentRecord.getPatient());
							setDefaultCloseOperation(EXIT_ON_CLOSE);
						}
					}
				}
			...
			textField = new JTextField();
			textField
					.setText(treatmentRecord.getTreatingDoctor().getUsername());
			textField.addKeyListener(new KeyAdapter() {
				@Override
				public void keyTyped(KeyEvent arg0) {
					changed = true;
			 ...
			 */
			textField_2 = new JTextField();
			textField_2.setText(treatmentRecord.getAttendingNurse()
					.getUsername());
			textField_2.addKeyListener(new KeyAdapter() {
				@Override
				public void keyTyped(KeyEvent arg0) {
			...
			textField_7 = new JTextField();
			textField_7
					.setText(treatmentRecord.getDoctorsOrders().getLabWork());
			textField_7.addKeyListener(new KeyAdapter() {
				@Override
				public void keyTyped(KeyEvent arg0) {
					changed = true;
			...
			textField_9 = new JTextField();
			textField_9.setText(treatmentRecord.getDoctorsOrders()
					.getOtherInstr());
			textField_9.addKeyListener(new KeyAdapter() {
				@Override
				public void keyTyped(KeyEvent arg0) {
