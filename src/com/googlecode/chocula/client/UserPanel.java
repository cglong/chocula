...
public class UserPanel extends JPanel implements UIInfo {
	...
	public UserPanel() {
		...
		add(lblUser, "2, 22, right, default");
		
		textFieldUsername = new JTextField();
		add(textFieldUsername, "4, 22, fill, default");
		textFieldUsername.setColumns(10);
		
		JLabel lblPassword = new JLabel("Password:");
		add(lblPassword, "2, 28, right, default");
		
		textFieldPassword = new JTextField();
		add(textFieldPassword, "4, 28, fill, default");
		...
		add(btnDelete, "4, 40, right, default");
	}
